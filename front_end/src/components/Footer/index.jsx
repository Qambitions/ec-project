                ...
                <div className="footer-info">
                    ...
                    <div>
                        ...
                        <div className='footer__icon_container_horizontal'>
                            <img style={{height:"35px"}} src={"https://res.cloudinary.com/ec-2022-lam-zau-khum-kho/image/upload/v1655832639/icon/888870_wptg5q.png"}></img>
                            <img style={{height:"35px"}} src={"https://res.cloudinary.com/ec-2022-lam-zau-khum-kho/image/upload/v1655832642/icon/momo-logo-ED8A3A0DF2-seeklogo.com_pnirvg.png"}></img>
                            <img style={{height:"35px"}} src={"https://res.cloudinary.com/ec-2022-lam-zau-khum-kho/image/upload/v1655832640/icon/2543174_viafmp.png"}></img>
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className='footer__icon_container_horizontal'>
                            <img style={{height:"35px"}} src={"https://res.cloudinary.com/ec-2022-lam-zau-khum-kho/image/upload/v1655832638/icon/145802_sodwfz.png"}></img>
                            <img style={{height:"35px"}} src={"https://res.cloudinary.com/ec-2022-lam-zau-khum-kho/image/upload/v1655832642/icon/3955024_u8cbqr.png"}></img>
                            <img style={{height:"35px"}} src={"https://res.cloudinary.com/ec-2022-lam-zau-khum-kho/image/upload/v1655832642/icon/3670147_ponygk.png"}></img>
                        </div>
                        <h5>Chứng nhận</h5>
                        <div className='footer__icon_container_horizontal '>
                            <img style={{height:"35px"}} src={"https://res.cloudinary.com/ec-2022-lam-zau-khum-kho/image/upload/v1656574904/icon/noi-khong-voi-hang-gia_xvgmlk.webp"}></img>
                            <img style={{height:"35px"}} src={"https://res.cloudinary.com/ec-2022-lam-zau-khum-kho/image/upload/v1656574898/icon/20150827110756-dadangky_vqvyli.png"}></img>
                        </div>
                    </div>
